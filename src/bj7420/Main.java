...
public class Main {
    public static void main(String[] args) throws IOException {
        ...
        points.addFirst(p0);
        bw.write(Math.round(calWallLength(convexHull(points), L)) + "");
        br.close();
        bw.close();
    }
    ...
    public static double calWallLength(Stack<Point> stack, int L) {
